# Bayesian calibration of a biology-based mathematical model using serial tumor volume and [<sup>89</sup>Zr]-CD8 PET to predict the response of triple-negative breast cancer
